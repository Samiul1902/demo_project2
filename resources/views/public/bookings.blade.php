    ...
    <section style="padding: 2.5rem 0 3rem 0;">
        <div class="container fade-in-up">
            ...
            <p style="font-size:0.9rem; color:#9ca3af; margin-bottom:1.6rem;">
                ...
                business rules (e.g., 24 hours before appointment).
            </p>
            ...
            <div style="display:flex; gap:0.75rem; margin-bottom:1.3rem; font-size:0.85rem;">
                ...
                <button type="button" class="btn glow-btn" style="padding:0.4rem 1rem; background:transparent; border-color:rgba(148,163,184,0.6);">
                    Past
                </button>
            </div>

            {{-- Example bookings list (static for now) --}}
            @php
                $bookings = [
                    [
                        'id' => 'SSB-2025-001',
            ...
            <div style="display:flex; flex-direction:column; gap:0.9rem;">
                @foreach($bookings as $b)
                    @php
                        $statusClass = $b['status'] === 'Confirmed'
                            ? 'status-confirmed'
                            : 'status-completed';
                    @endphp
